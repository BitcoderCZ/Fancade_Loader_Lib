// <copyright file="RawPrefabSetting.cs" company="BitcoderCZ">
...
/// </remarks>
public struct RawPrefabSetting : IEquatable<RawPrefabSetting>
{
    private SettingType _type;
    private object _value;

    /// <summary>
    /// Initializes a new instance of the <see cref="RawPrefabSetting"/> struct.
    /// </summary>
    ...
    public RawPrefabSetting(byte index, SettingType type, ushort3 pos, object value)
    {
    ...
    /// </remarks>
    /// <value>Index of the <see cref="RawPrefabSetting"/>.</value>
    ...
    /// <summary>Returns a value that indicates whether the 2 <see cref="RawPrefabSetting"/>s are equal.</summary>
    /// <param name="left">The first <see cref="RawPrefabSetting"/> to compare.</param>
    /// <param name="right">The second <see cref="RawPrefabSetting"/> to compare.</param>
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> are equal; otherwise, <see langword="false"/>.</returns>
    public static bool operator ==(RawPrefabSetting left, RawPrefabSetting right)
        => left.Index == right.Index && left.Position == right.Position && left.Type == right.Type && Equals(left.Value, right.Value);

    /// <summary>Returns a value that indicates whether the 2 <see cref="RawPrefabSetting"/>s are not equal.</summary>
    /// <param name="left">The first <see cref="RawPrefabSetting"/> to compare.</param>
    /// <param name="right">The second <see cref="RawPrefabSetting"/> to compare.</param>
    ...
    /// <returns>The <see cref="SettingType"/> for <paramref name="value"/> or null if <paramref name="value"/> isn't a valid <see cref="RawPrefabSetting"/> value.</returns>
    ...
    /// <summary>
    /// Loads a <see cref="RawPrefabSetting"/> from a <see cref="FcBinaryReader"/>.
    /// </summary>
    /// <param name="reader">The reader to read the <see cref="RawPrefabSetting"/> from.</param>
    /// <returns>A <see cref="RawPrefabSetting"/> read from <paramref name="reader"/>.</returns>
    public static RawPrefabSetting Load(FcBinaryReader reader)
    {
        ...
        return new RawPrefabSetting(valueIndex, type, pos, value);
    }

    /// <summary>
    /// Writes a <see cref="RawPrefabSetting"/> into a <see cref="FcBinaryWriter"/>.
    /// </summary>
...
#pragma warning restore CS9191 // The 'ref' modifier for an argument corresponding to 'in' parameter is equivalent to 'in'. Consider using 'in' instead.
    ...
    /// <inheritdoc/>
    public readonly bool Equals(RawPrefabSetting other)
        => this == other;

    /// <inheritdoc/>
    public readonly override bool Equals(object? obj)
        => obj is RawPrefabSetting other && this == other;
