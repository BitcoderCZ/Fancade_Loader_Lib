// <copyright file="ScreenToWorldExpressionSyntax.cs" company="BitcoderCZ">
...
public sealed class ScreenToWorldExpressionSyntax : SyntaxNode
{
    ...
    public ScreenToWorldExpressionSyntax(int3 position, SyntaxTerminal? screenX, SyntaxTerminal? screenY)
        : base(216, position)
    {
        ScreenX = screenX;
        ScreenY = screenY;
