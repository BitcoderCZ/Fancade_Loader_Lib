// <copyright file="SetCameraStatementSyntax.cs" company="BitcoderCZ">
...
public sealed class SetCameraStatementSyntax : StatementSyntax
{
    ...
    public SetCameraStatementSyntax(int3 position, ImmutableArray<Connection> outVoidConnections, SyntaxTerminal? positionTerminal, SyntaxTerminal? rotationTerminal, SyntaxTerminal? rangeTerminal, bool perspective)
