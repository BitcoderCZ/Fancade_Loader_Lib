// <copyright file="CreateObjectStatementSyntax.cs" company="BitcoderCZ">
...
public sealed class CreateObjectStatementSyntax : StatementSyntax
{
    ...
    public CreateObjectStatementSyntax(int3 position, ImmutableArray<Connection> outVoidConnections, SyntaxTerminal? original)
