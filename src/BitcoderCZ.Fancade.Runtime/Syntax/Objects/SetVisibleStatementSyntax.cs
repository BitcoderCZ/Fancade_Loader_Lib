// <copyright file="SetVisibleStatementSyntax.cs" company="BitcoderCZ">
...
public sealed class SetVisibleStatementSyntax : StatementSyntax
{
    ...
    public SetVisibleStatementSyntax(int3 position, ImmutableArray<Connection> outVoidConnections, SyntaxTerminal? @object, SyntaxTerminal? visible)
