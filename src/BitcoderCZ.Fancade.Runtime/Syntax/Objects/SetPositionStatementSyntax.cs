// <copyright file="SetPositionStatementSyntax.cs" company="BitcoderCZ">
...
public sealed class SetPositionStatementSyntax : StatementSyntax
{
    ...
    public SetPositionStatementSyntax(int3 position, ImmutableArray<Connection> outVoidConnections, SyntaxTerminal? objectTerminal, SyntaxTerminal? positionTerminal, SyntaxTerminal? rotationTerminal)
