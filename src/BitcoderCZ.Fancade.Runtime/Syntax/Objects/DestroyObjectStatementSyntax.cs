// <copyright file="DestroyObjectStatementSyntax.cs" company="BitcoderCZ">
...
public sealed class DestroyObjectStatementSyntax : StatementSyntax
{
    ...
    public DestroyObjectStatementSyntax(int3 position, ImmutableArray<Connection> outVoidConnections, SyntaxTerminal? @object)
