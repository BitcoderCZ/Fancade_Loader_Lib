// <copyright file="SetBouncinessStatementSyntax.cs" company="BitcoderCZ">
...
public sealed class SetBouncinessStatementSyntax : StatementSyntax
{
    ...
    public SetBouncinessStatementSyntax(int3 position, ImmutableArray<Connection> outVoidConnections, SyntaxTerminal? @object, SyntaxTerminal? bounciness)
