// <copyright file="Interpreter.cs" company="BitcoderCZ">
                ...
                case 316:
                    {
                        ...
                        {
                            environment.BlockData[createObject.Position] = _ctx.CreateObject((FcObject)GetValue(createObject.Original, environment).Int, new EnvironmentPosition(environment, statement.Position)).Value;
                        }
                    }
            ...
            case 90 or 144 or 440 or 413 or 453 or 184 or 186 or 188 or 455 or 578:
                {
                    ...
                    value = terminal.Node.PrefabId switch
                    {
                        ...
                        413 => new(MathF.Sin(input.Float * (MathF.PI / 180f))),
                        453 => new(MathF.Cos(input.Float * (MathF.PI / 180f))),
